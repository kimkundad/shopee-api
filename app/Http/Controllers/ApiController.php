...
class ApiController extends Controller
{
    ...
    public function dashboard(Request $request)
    {
        ...
        $sum = DB::table('order_details')
            ...
            ->selectRaw('products.name_product, SUM(CASE WHEN products.type = 1 THEN products.price WHEN products.type = 2 THEN product_options.price WHEN products.type = 3 THEN product_suboptions.price ELSE 0 END) AS total_price')
            ->get();
