...
Route::group([
    ...
    Route::post('/setStatusOrders/{id}/{status}', [App\Http\Controllers\ApiController::class, 'setStatusOrders']);
    ...
    Route::post('/total_reports' , [App\Http\Controllers\ApiController::class, 'total_reports']);
