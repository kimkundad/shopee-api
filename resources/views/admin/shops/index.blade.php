                                        ...
                                        <tr id="{{$item->id}}">
                                            ...
                                            <td class="text-end">
                                                <div class="d-flex justify-content-end flex-shrink-0">
                                                    <a href="{{url('admin/shops/'.$item->id.'/edit')}}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                    ...
                                                    <a href="{{ url('api/del_shops/'.$item->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
